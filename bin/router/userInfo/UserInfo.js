...
var UserInfoDao_1 = require("../../dao/UserInfoDao");
exports.route = express.Router();
exports.route.post('/useradmin/userlist', function (req, res, next) {
    (function () { return __awaiter(_this, void 0, void 0, function () {
        var dataRows, ret, msg, subMsg, type, type_content, page_size, page_now, limitBegin, UserInfoInstance, error_1, result;
...
exports.route.get('/useradmin/delete', function (req, res, next) {
    (function () { return __awaiter(_this, void 0, void 0, function () {
        var dataRows, ret, msg, subMsg, id, UserInfoDelInstance, error_2, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ret = RetStatus_1.RetCode.SUC_OK;
