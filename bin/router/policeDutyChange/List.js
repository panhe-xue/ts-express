...
var ListDao_1 = require("../../dao/policeDutyChange/ListDao");
exports.route = express.Router();
exports.route.get('/policeDutyChange/list', function (req, res, next) {
    (function () { return __awaiter(_this, void 0, void 0, function () {
        var dataRows, ret, msg, subMsg, page_info, content, page_size, page_now, limitBegin, PoliceDutyChangeInstance, result_1, allNum, error_1, error_2, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    PoliceDutyChangeInstance = new ListDao_1.ListDao(content, limitBegin, page_size);
                    result_1 = PoliceDutyChangeInstance.checkData();
                    //参数校验
                    if (!result_1.status) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, PoliceDutyChangeInstance.getAllNumFromDB()];
                case 3:
                    allNum = _a.sent();
                ...
                case 5:
                    _a.trys.push([5, 7, , 8]);
                    return [4 /*yield*/, PoliceDutyChangeInstance.getUserInfoFromDB()];
                case 6:
                    dataRows = _a.sent();
                    return [3 /*break*/, 8];
                case 7:
