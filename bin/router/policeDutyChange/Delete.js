...
var DeleteDao_1 = require("../../dao/policeDutyChange/DeleteDao");
exports.route = express.Router();
exports.route.get('/policeDutyChange/delete', function (req, res, next) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    DelInstance = new DeleteDao_1.policeDutyChangeDeleteDao(id);
                    //参数校验
