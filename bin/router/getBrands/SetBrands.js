...
// 订阅接口
exports.route.post('/setNewSubscribeBrands', function (req, res, next) {
    (function () { return __awaiter(_this, void 0, void 0, function () {
        var ret, msg, subMsg, openid, brand_id, allNum, error_1, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 8, , 9]);
                    return [4 /*yield*/, setBrandsDao.getHasThisBrands(openid, brand_id)];
                case 3:
                    allNum = _a.sent();
                    if (!(allNum.length === 0)) return [3 /*break*/, 5];
                    return [4 /*yield*/, setBrandsDao.insertThisBrands(openid, brand_id)];
                case 4:
                    _a.sent();
                    return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, setBrandsDao.updateThisBrands(openid, brand_id, 1)];
                case 6:
                    _a.sent();
                    _a.label = 7;
...
// 取消订阅接口
exports.route.post('/delThisBrands', function (req, res, next) {
    (function () { return __awaiter(_this, void 0, void 0, function () {
        var ret, msg, subMsg, openid, brand_id, allNum, error_2, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ret = RetStatus_1.RetCode.SUC_OK;
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, setBrandsDao.updateThisBrands(openid, brand_id, 0)];
                case 3:
                    allNum = _a.sent();
                    return [3 /*break*/, 5];
                case 4:
...
//# sourceMappingURL=SetBrands.js.map