...
var BrandsDao = /** @class */ (function () {
     ...
     * @return Array 数据
     */
    BrandsDao.prototype.getAllBrands = function (openid) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, rows, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sql = "select count(*) as count from " + BrandsDao.TABLE_NAME + " where openid = ? and status = 1";
     ...
     * 表名
     */
    BrandsDao.TABLE_NAME = "user_brands";
    return BrandsDao;
}());
exports.default = BrandsDao;
//# sourceMappingURL=BrandsDao.js.map