...
var LoginDao = /** @class */ (function () {
     ...
     * @return boolean 是否正确
     */
    LoginDao.prototype.checkData = function () {
     ...
     * @return Array 数据
     */
    LoginDao.prototype.getUserFromDB = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = [];
                        sql = "select account, password, id_card from " + LoginDao.TABLE_NAME + " where account = ?";
     ...
     * @return Array 数据
     */
    LoginDao.prototype.getUserInfo = function (id_card) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = [];
                        sql = "select * from " + LoginDao.TABLE_NAME_MSG + " where id_card = ?";
     ...
     * 表名
     */
    LoginDao.TABLE_NAME = "account";
    LoginDao.TABLE_NAME_MSG = "user_info";
    return LoginDao;
}());
