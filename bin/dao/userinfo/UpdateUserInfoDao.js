 ...
 * 人员增加类
 */
var UpdateUserInfoDao = /** @class */ (function () {
    function UpdateUserInfoDao(params) {
        this.params = params;
    }
    /**
     * 检查数据的正确性
     * @return boolean 是否正确
     */
    UpdateUserInfoDao.prototype.checkData = function () {
        var self = this;
     ...
     * @return Array 数据
     */
    UpdateUserInfoDao.prototype.doAdd = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = [];
                        whereSqlString = '';
                        sql = "insert into " + UpdateUserInfoDao.TABLE_NAME + " (" + UpdateUserInfoDao.INSERT_FEILD.join(',') + ") values (?)";
                        console.info("get user info from db sql:", sql);
                        values = UpdateUserInfoDao.INSERT_FEILD.map(function (item) { return (_this.params[item] || '0'); });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
     ...
     * 表名
     */
    UpdateUserInfoDao.TABLE_NAME = "user_info";
    UpdateUserInfoDao.INSERT_FEILD = [
    ...
    return UpdateUserInfoDao;
}());
exports.UpdateUserInfoDao = UpdateUserInfoDao;
//# sourceMappingURL=UpdateUserInfoDao.js.map