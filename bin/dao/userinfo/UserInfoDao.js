...
var UserInfoDao = /** @class */ (function () {
     ...
     * @return Array 数据
     */
    UserInfoDao.prototype.getAllNumFromDB = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        whereSqlString = '';
                        whereSqlString = this.getWhereSqlStr();
                        sql = "select count(*) as c from " + UserInfoDao.TABLE_NAME + " " + whereSqlString + ";";
                        sql = mysql.format(sql, [this.pageBegin, this.pageSize]);
                        console.info("get user info from db sql:", sql);
                        _a.label = 1;
                    case 1:
...
var UserInfoDeleteDao = /** @class */ (function () {
    ...
    UserInfoDeleteDao.prototype.doDel = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result, whereSqlString, sql, rows, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = [];
