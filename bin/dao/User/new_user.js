...
var NewUser = /** @class */ (function () {
     ...
     * @return boolean|date
     */
    NewUser.prototype.is_new_user = function (openid) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, sql1, rows, rows1, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        rows = _a.sent();
                        if (!(rows.length <= 1)) return [3 /*break*/, 3];
     ...
     * 表名
     */
    NewUser.TABLE_NAME_LOG = "user_logs";
    NewUser.TABLE_NAME_USER = "user";
    return NewUser;
}());
